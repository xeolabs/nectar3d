...
class ZMinSliceExtractionStrategy implements SliceExtractionStrategy {
    public ZMinSliceExtractionStrategy(SliceExtractionContext context, Slice slice) {
        this.slice = slice;
    ...
    public void extract() throws SceneException {
        ...
        */
        ...
        context.interpolate(extract, TransformGroup.ROTY_VAL, 800, 1600, 180.0);
    ...
    public void restore() throws SceneException {
        context.interpolate(extract, TransformGroup.TRAZ_VAL, 800, 1600, 0.0);
